...
for run_id in [9]:
    safe_costs, safe_objs, con_costs, con_objs, vabo_costs_tmp, \
        ...
        con_obj_traj, con_constrs, pdbo_obj_traj, pdbo_constrs, \
        vabo_obj_traj_tmp, vabo_constrs_tmp, lcb2_costs, lcb2_objs, lcb2_opt, \
        lcb2_obj_traj, lcb2_constrs, problem_config = run_one_instance(run_id)
...
# In[87]:
    ...
    np.savez('test_Prob_set_result_with_pdbo', safe_ave_cost_arr, safe_ave_simple_regret_arr, con_ave_cost_arr, con_ave_simple_regret_arr, vabo_ave_cost_arr_set,
