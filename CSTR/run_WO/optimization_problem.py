...
class OptimizationProblem:
    ...
    def __init__(self, config):
        ...
        if self.problem_name == 'merl_simulator' or self.problem_name == 'merl_simulator_with_TEvap' in self.problem_name \
                or config['eval_simu']:
            self.simulator = None
    ...
    def sample_point(self, x, reset_init=False):
        if self.problem_name == 'merl_simulator' or 'energym' in self.problem_name:
        ...
        for g in self.constrs_list:
            if self.problem_name == 'merl_simulator':
                constr_val, simulator, pow_arr = g(x, self.simulator)
                self.simulator = simulator
                constraint_val_list.append((constr_val))
            else:
