...
class ViolationAwareBO:
        ...
        for i in range(self.opt_problem.num_constrs):
            ...
            self.gp_constr_list.append(
                GPy.models.GPRegression(
                    self.x0_arr,
                    np.expand_dims(self.init_constr_val_arr[:, i], axis=1) -
                    gp_constr_mean,
    ...
    def get_acquisition(self, type='budget_aware_EIc', lcb_beta=3):
    ...
    def get_beta(self):
        return min(max(self.curr_eval_budget, 1),
