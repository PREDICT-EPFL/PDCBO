...
for traj_id in range(traj_num):
    ...
    constraints2_list_pdcbo_list.append(constraints2_list_pdcbo)
    ...
    constraints2_list_cbo_list.append(constraints2_list_cbo)
    ...
    constraints2_list_safebo_list.append(constraints2_list_safebo)
