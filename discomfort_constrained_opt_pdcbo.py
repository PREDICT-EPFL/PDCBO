...
discomfort_thr_to_contexts_pdcbo = dict()
...
def run_opt(bo_config, optimizer_type):
    ...
    discomfort_thr_to_contexts_dict = dict() 
    for discomfort_thr in discomfort_thr_list:
        ...
        discomfort_thr_to_contexts_dict[discomfort_thr] = \
                contexts_list
    ...
    return discomfort_thr_to_discomfort, discomfort_thr_to_energy, \
        ...
        discomfort_thr_to_history_dict, discomfort_thr_to_contexts_dict
...
discomfort_thr_to_discomfort_pdcbo, discomfort_thr_to_energy_pdcbo, \
    ...
    discomfort_thr_to_contexts_pdcbo = run_opt(pdcbo_config, optimizer_type)

now_time_str = datetime.datetime.now().strftime(
        "%H_%M_%S-%b_%d_%Y")

with open(f'./result/discomfort_constrained_energy_min_pdcbo_{now_time_str}.pkl',
          'wb') as f:
    pickle.dump([
        ...
        discomfort_thr_to_contexts_pdcbo
    ], f)
